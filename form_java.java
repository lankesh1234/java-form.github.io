...
class Myframe extends JFrame implements ActionListener {
    ...
    JLabel label1, label2, label3, label4, label5; // to declare component
    JTextField t1, t2; // for text name and mobile
    JRadioButton male, female; // for select gender
    JComboBox day, month, year; // for date of birth
    JTextArea ta1; // for address
    JCheckBox terms;
    JButton submit;
    JLabel msg;
    JTextArea screen;
    ...
    Myframe() {
        ...
        String years[] = { "1998", "1999", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008",
    ...
    public void actionPerformed(ActionEvent e) {
        if (terms.isSelected()) {
            ...
            msg.setText("First accept terms and conditions to submit");
            screen.setText("");
        }
    }
}

public class form_java {
